      ...
      <div className="row">
        <div className="col-md-3 left-column">
          ...
          <div className="search-bar">
            ...
            <div className="black-line-1"></div> {/* Black line */}
            <div className="black-line-2"></div> {/* Black line */}
            ...
            <div className="black-line-3"></div> {/* Black line */}
            <div className="checkbox-section">
            ...
            <div className="black-line-4"></div> {/* Black line */}
          </div>
        </div>
